...
#ifndef ADVERSARIAL_GENERATION_H
#define ADVERSARIAL_GENERATION_H
...
class AdversarialGeneration : public Application 
{
public:
  /**
...
private:
  ...
  Time            m_initTime;     // Time where first packet is sent
  Time            m_period;
  bool            m_stop;

  /// Traced Callback: transmitted packets.
  TracedCallback<Ptr<const Packet> > m_txTrace;
  TracedCallback<Time> m_txTimeLocal;
  TracedCallback<Time> m_txTimeGlobal;
